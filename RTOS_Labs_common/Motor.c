...
#include "../RTOS_Labs_common/Motor.h"


#define SERVOMAX 3275
...
// ~~~~~Motor~~~~~	
// This function will act as the main control thread	
//  for the motor board.	
// Inputs: None	
// Outputs: None
void Motor(void){ // use this with motor board version 5
